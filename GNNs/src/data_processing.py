...
from src.utils.graph_preprocess import preprocess_chemical_data_atomic
from src.utils.to_smiles import map_to_smiles
...
class PreProcess:
    ...
    preset_elements = ('Ag', 'Al', 'As', 'Au', 'B', 'Ba', 'Bi', 'Br', 'C', 'Ca', 'Cd', 'Ce', 'Co', 'Cr', 'Cs', 'Cu',
                       'Fe', 'Ga', 'Gd', 'Ge', 'H', 'Hf', 'Hg', 'In', 'Ir', 'K', 'La', 'Li', 'Mg', 'Mn', 'Mo', 'N',
                       'Na', 'Nb', 'Nd', 'Ni', 'O', 'Os', 'P', 'Pb', 'Pd', 'Pt', 'Rb', 'Re', 'Rh', 'Ru', 'Sb', 'Sc',
                       'Si', 'Sn', 'Sr', 'Ta', 'Tc', 'Te', 'Ti', 'Tl', 'V', 'W', 'Y', 'Zn', 'Zr')

    @staticmethod
    def encoded_alloy(alloys_to_encode, elements=preset_elements):
